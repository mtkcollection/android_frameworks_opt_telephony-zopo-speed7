...
/* Vanzo:hanshengpeng on: Wed, 04 Mar 2015 17:42:38 +0800
 */
...
/* Vanzo:hanshengpeng on: Wed, 04 Mar 2015 21:13:20 +0800
 * custom sms templates
        "#suoding#",
 */
        FeatureOption.VANZO_FEATURE_STRING_SMS_TEMPLATES_LOCK.replace("$","#"),
// End of Vanzo:hanshengpeng
        "已接受到您的锁屏指令，锁屏成功。",
/* Vanzo:hanshengpeng on: Wed, 04 Mar 2015 21:13:40 +0800
 * custom sms templates
        "#jiesuo#",
 */
        FeatureOption.VANZO_FEATURE_STRING_SMS_TEMPLATES_UNLOCK.replace("$","#"),
// End of Vanzo:hanshengpeng
        "已接受到您的解锁指令，解锁成功。",
/* Vanzo:hanshengpeng on: Wed, 04 Mar 2015 21:13:44 +0800
 * custom sms templates
        "#mima#",
 */
        FeatureOption.VANZO_FEATURE_STRING_SMS_TEMPLATES_PASSWORD.replace("$","#"),
// End of Vanzo:hanshengpeng
        "您的手机防盗密码为%s。",
/* Vanzo:hanshengpeng on: Wed, 04 Mar 2015 21:13:50 +0800
 * custom sms templates
        "#xiaohui#",
 */
        FeatureOption.VANZO_FEATURE_STRING_SMS_TEMPLATES_DESTROY.replace("$","#"),
// End of Vanzo:hanshengpeng
        "远程删除数据已开始。",
        "远程数据删除已完成，您的隐私得到保护，请放心。",
/* Vanzo:hanshengpeng on: Wed, 04 Mar 2015 21:15:47 +0800
 * custom sms templates
        "我开启了手机防盗功能，已将你的手机号码设置为紧急联系人号码，这样手机丢失也能够远程控制啦。\n以下是相关指令：\n远程锁定： #suoding#\n远程销毁数据： #xiaohui#\n找回密码： #mima#",
 */
        "我开启了手机防盗功能，已将你的手机号码设置为紧急联系人号码，这样手机丢失也能够远程控制啦。\n以下是相关指令：\n远程锁定： "+FeatureOption.VANZO_FEATURE_STRING_SMS_TEMPLATES_LOCK.replace("$","#")+"\n远程销毁数据： "+FeatureOption.VANZO_FEATURE_STRING_SMS_TEMPLATES_DESTROY.replace("$","#")+"\n找回密码： "+FeatureOption.VANZO_FEATURE_STRING_SMS_TEMPLATES_PASSWORD.replace("$","#"),
// End of Vanzo:hanshengpeng
    };

    private static final String[] SMS_PATTERNS = {
        "我的手机可能被盗，请保留发送此短信的号码。",
/* Vanzo:hanshengpeng on: Wed, 04 Mar 2015 21:14:39 +0800
 * custom sms templates
        " *#suoding# *",
 */
        " *" + FeatureOption.VANZO_FEATURE_STRING_SMS_TEMPLATES_LOCK.replace("$","#") + " *",
// End of Vanzo:hanshengpeng
        "已接受到您的锁屏指令，锁屏成功。",
/* Vanzo:hanshengpeng on: Wed, 04 Mar 2015 21:14:43 +0800
 * custom sms templates
        " *#jiesuo# *",
 */
        " *" + FeatureOption.VANZO_FEATURE_STRING_SMS_TEMPLATES_UNLOCK.replace("$","#") + " *",
// End of Vanzo:hanshengpeng
        "已接受到您的解锁指令，解锁成功。",
/* Vanzo:hanshengpeng on: Wed, 04 Mar 2015 21:14:46 +0800
 * custom sms templates
        " *#mima# *",
 */
        " *" + FeatureOption.VANZO_FEATURE_STRING_SMS_TEMPLATES_PASSWORD.replace("$","#") + " *",
// End of Vanzo:hanshengpeng
        "您的手机防盗密码为[0-9]*。",
/* Vanzo:hanshengpeng on: Wed, 04 Mar 2015 21:14:51 +0800
 * custom sms templates
        " *#xiaohui# *",
 */
        " *" + FeatureOption.VANZO_FEATURE_STRING_SMS_TEMPLATES_DESTROY.replace("$","#") + " *",
// End of Vanzo:hanshengpeng
        "远程删除数据已开始。",
        "远程数据删除已完成，您的隐私得到保护，请放心。",
/* Vanzo:hanshengpeng on: Wed, 04 Mar 2015 21:16:53 +0800
 * custom sms templates
        "我开启了手机防盗功能，已将你的手机号码设置为紧急联系人号码，这样手机丢失也能够远程控制啦。\n以下是相关指令：\n远程锁定： #suoding#\n远程销毁数据： #xiaohui#\n找回密码： #mima#",
 */
        "我开启了手机防盗功能，已将你的手机号码设置为紧急联系人号码，这样手机丢失也能够远程控制啦。\n以下是相关指令：\n远程锁定： "+FeatureOption.VANZO_FEATURE_STRING_SMS_TEMPLATES_LOCK.replace("$","#")+"\n远程销毁数据： "+FeatureOption.VANZO_FEATURE_STRING_SMS_TEMPLATES_DESTROY.replace("$","#")+"\n找回密码： "+FeatureOption.VANZO_FEATURE_STRING_SMS_TEMPLATES_PASSWORD.replace("$","#"),
