...
public class CatService extends Handler implements AppInterface {
     ...
     */
/* Vanzo:tanglei on: Tue, 07 Jul 2015 20:00:52 +0800
 */
    private String oldStkName = "stk";
...
/* Vanzo:tanglei on: Tue, 07 Jul 2015 19:59:30 +0800
 */
                    if (com.android.featureoption.FeatureOption.VANZO_FEATURE_STK_NAME_READ_FROM_SIM) {
                        String newStkName = ((SelectItemParams) cmdParams).mMenu.title;
                        android.util.Log.d("tanglei", "newStkName = " + newStkName);
                        if(!oldStkName.equals(newStkName)){
                            SystemProperties.set("gsm.stkapp.name", newStkName);
                            Intent intent = new Intent();
                            intent.setAction("com.stk.simname");
                            mContext.sendBroadcast(intent);
                            oldStkName = newStkName;
                        }
                    }
// End of Vanzo:tanglei
